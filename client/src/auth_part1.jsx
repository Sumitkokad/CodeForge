...
const Auth = () => {
  ...
  return (
    <div className="auth-container">
      ...
      <div className="auth-circle top-1/4 -left-20 bg-blue-400" />
      <div className="auth-circle top-3/4 -right-20 bg-blue-300 animation-delay-2000" />
      <div className="auth-circle bottom-1/4 left-1/2 transform -translate-x-1/2 bg-blue-200 animation-delay-4000" />
